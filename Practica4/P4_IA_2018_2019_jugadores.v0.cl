...
(loop for columna from 0 below (tablero-ancho tablero) do
    ...
    ;; caso menor que 12 (heuristica ponderada para apertura de partida)
     ...
     ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
       ...
       (ponderacion3 (cond ((or (= columna 0) (= columna 6)) 1)
                          ((or (= columna 1) (= columna 5)) 1.1)
                          ((or (= columna 2) (= columna 4)) 1.3)
                          ((= columna 3) 1.5))))


  (if (< (contar-fichas tablero) 18)
  ;; caso menor que 12 (heuristica ponderada para apertura de partida)
  (setf puntuacion-oponente
        (* ponderacion3 (+ puntuacion-oponente
     (cond ((= abajo 0) 0)
           ((= abajo 1) 15)
           ((= abajo 2) 150)
           ((= abajo 3) 5000))
...
(defun f-eval-bueno-guille (estado); current player standpoint
(let* ((tablero (estado-tablero estado))
 (ficha-actual (estado-turno estado))
 (ficha-oponente (siguiente-jugador ficha-actual)))
  (if (juego-terminado-p estado)
